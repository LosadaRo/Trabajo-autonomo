...
lyr_Puntosvertederos_2.set('fieldLabels', {'Pueblo': 'no label', 'X': 'no label', 'Y': 'no label', 'localizaci': 'no label', });
lyr_Nucleospoblacin_3.set('fieldLabels', {'NOMBRE': 'inline label', });
